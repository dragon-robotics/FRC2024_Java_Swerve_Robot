...
public class UptakeReverse100Command extends Command {
  private UptakeSubsystem m_uptakeSubsystem;

  /** Creates a new Uptake100Command. */
  public UptakeReverse100Command(UptakeSubsystem uptakeSubsystem) {
  ...
  @Override
  public void execute() {
    m_uptakeSubsystem.setSpeedReverse100();
  }
